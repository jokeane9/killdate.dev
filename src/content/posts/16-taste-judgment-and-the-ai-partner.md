...
Humans are evolutionarily wired for loss aversion — costs register at roughly twice the psychological weight of equivalent gains. AI makes that asymmetry visceral: the skills you spent years building are suddenly worth less, the job role that was already precarious is now more so, and the identity you went into debt to build is replicated by a model in seconds. The upside is abstract, somewhere in the future. The problems land now. Your brain isn't doing the math wrong. It's doing it exactly right — and this time, the threat it's calculating is structural.
